from materials.views import CourseViewSet, SubscriptionCreateAPIView, CoursePaymentAPIView
...
urlpatterns = [
    ...
    path('course_payment/', CoursePaymentAPIView.as_view(), name='course_payment'),
] + router.urls
